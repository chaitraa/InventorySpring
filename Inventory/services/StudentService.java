...
public class StudentService {
    ...
    public List<Student> findByField(String text)
    {
        ...
        List<Student> studentListResult=
                studentList.stream().filter(t-> t.getCourse().equals(text) || t.getName().equals(text) || t.getId().equals(text) || (t.getGpa() == Double.parseDouble(text)))
